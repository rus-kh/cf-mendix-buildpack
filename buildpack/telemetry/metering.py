...
def _download(buildpack_dir, build_path, cache_dir):
    util.resolve_dependency(
        ...
        # ),
        "https://artifactory.rnd.mendix.com/artifactory/cloud-snapshot-local/com/mendix/cloud/metering-sidecar/v2.0.0_MET-597_Delta_processing_468718-SNAPSHOT/metering-sidecar-linux-amd64-v2.0.0_MET-597_Delta_processing_468718-SNAPSHOT.tar.gz", # hardcoded for test deployment
